...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
      ...
      <p class="lead">This is a very simple website template that uses bootstrap CSS framework! This is another new code to push for the github SCM poll!!! Another new code for the Webhook from Github</p>
